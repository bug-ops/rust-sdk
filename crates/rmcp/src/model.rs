...
impl Reference {
    ...
    /// Create a resource template reference  
    pub fn for_resource_template(uri: impl Into<String>) -> Self {
...
///
/// According to MCP 2025-06-18 specification, this should be ResourceTemplateReference
/// to distinguish from regular resource references.
#[derive(Debug, Serialize, Deserialize, Clone, PartialEq)]
#[cfg_attr(feature = "schemars", derive(schemars::JsonSchema))]
...
#[deprecated(since = "0.7.0", note = "Use ResourceTemplateReference instead")]
